<?php
	...
	if(isset($_POST['remove_user'])){
		...
		$sql = "delete from $tableName where EmployerId = '$rowId'";
		
		$tempSql = "delete from jobs where EmployerId = '$rowId'";

		mysqli_query($conn, $tempSql);

		if(mysqli_query($conn, $sql)){
			header("Lcation: employerListPage.php");
			echo "
			...
			<div>
				...
				?>
					    		<tr>
					    			...
					    			<td>
					    				<form name="removeButtonForm" action="removeEmployer.php" method="POST">
