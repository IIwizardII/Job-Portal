...
<body>
	...
	<div>
		<div style="border: 0px solid #18a0b5; margin-top: 200px; margin-left: 15%; margin-right: 15%; 
		margin-bottom: 100px; background-color: white; padding: 20px">
			<div>
				<img src="images/test.jpg" alt="Admin" width="200" height="260">
				...
				<div style="margin-top: 20px;">
					<p>
						This website is a academic project created by Md Masrafi Rahman. For any query you can contact at <a href="mailto:2016-2-60-128@std.ewubd.edu">2016-2-60-128@std.ewubd.edu</a>.<br>
					</p>
				</div>
			</div>
