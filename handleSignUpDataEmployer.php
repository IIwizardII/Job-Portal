	...
	$sqlQuery = "INSERT INTO $tableName(CompanyEmail, UserName, Password, CompanyName, Country, District, Thana, WholeAddress,
										IndustryType, BusinessDescription, CompanyMobile)
				VALUES (
					'$_POST[mail]', 
					'$_POST[user_name]', 
					'$_POST[password_name]',
					...
					'$_POST[district_name]',
					'$_POST[thana_name]',
					'$_POST[wholeAddress_name]', 
					'$_POST[industryType_name]', 
					'$_POST[businessDescription_name]',
					'$_POST[phone_number]'
